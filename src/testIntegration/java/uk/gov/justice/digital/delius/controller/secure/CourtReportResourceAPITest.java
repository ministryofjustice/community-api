...
class CourtReportResourceAPITest extends IntegrationTestBase {
    ...
    void givenKnownValues_whenGetCourtReportsByCrnAndConvictionId_thenReturn() {
        given()
            ...
            .body("[0].reportManagers[0].forenames", equalTo("Unallocated Staff(N02)"))
            .body("[0].reportManagers[0].surname", equalTo("Staff"))
            .body("[0].reportManagers[0].unallocated", is(true))
