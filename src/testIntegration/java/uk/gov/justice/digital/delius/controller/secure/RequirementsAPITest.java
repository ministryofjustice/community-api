...
public class RequirementsAPITest extends IntegrationTestBase {
    ...
    public void getRequirementsByConvictionId_convictionsFound_returnsOk() {
        ...
        given()
                ...
                .body("requirements[0].requirementTypeMainCategory.description", equalTo("Rehabilitation Activity Requirement (RAR)"))
                ...
                .body("requirements[0].lengthUnit", equalTo("Days"))
