...
public interface AssessmentDocumentRepository extends JpaRepository<AssessmentDocument, Long> {
    @Query("select document from AssessmentDocument document, Assessment entity where document.assessment = entity and document.offenderId = :offenderId and document.softDeleted = 0")
