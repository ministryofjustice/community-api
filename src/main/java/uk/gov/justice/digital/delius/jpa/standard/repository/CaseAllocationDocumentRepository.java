...
public interface CaseAllocationDocumentRepository extends JpaRepository<CaseAllocationDocument, Long> {
    @Query("select document from CaseAllocationDocument document, CaseAllocation entity where document.caseAllocation = entity and document.offenderId = :offenderId and document.softDeleted = 0")
