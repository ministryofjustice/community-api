...
public interface EventRepository extends JpaRepository<Event, Long> {
    ...
    @Query("select event from Event event where event.offenderId = :offenderId and event.activeFlag = 1 and eventId = :eventId")
    Optional<Event> findByOffenderIdAndEventIdAndActiveTrue(Long offenderId, Long eventId);
